...
3. [MODEL TAB]
  ...
  2.2 Select final checkpoint path (Model Output Desitination)
...
- Text encoder learning rate is lower than model learning rate. Be careful, if you ise the same learning rate it will burn the model
...
12. Start stable-diffusion-webui
  ...
  12.1 Load checkpoint `RealVisXL_V4.0.safetensors`

  12.1.1 If you created LORA then use:
  ```
  1024x1024
  Sampling Steps: 40
  CFG Scale: 7
